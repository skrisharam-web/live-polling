...
WebSocket-capable backend host. Everything above has been exercised against a
locally running production-mode build, including the startup refusals and the
production cookie attributes; what remains is creating the accounts and running
the five steps.
